...
use camera::camera_transform;
#[cfg(test)]
use camera::{
    ai_tactical_camera_pose, camera_pose_for_intent, camera_presentation_intent,
    clamp_camera_pitch, clamp_camera_target, human_shot_camera_pose, interpolate_camera_pose,
        ...
        .add_systems(
            ...
            (
                (
                    ...
                    camera::update_battlefield_camera,
                    camera::rotate_menu_camera,
                    handle_setup_clicks,
                    update_match_setup,
                    sync_match_setup_ui,
